...
<@layout.registrationLayout displayInfo=true; section>
	...
	<script>
		...
		window.addEventListener("DOMContentLoaded", () => {
				const inputOTP = document.getElementById("code");
	...
	<#elseif section = "form">
		<div id="input-contain">
			<label for="code" id="label-OTP" class="${properties.kcLabelClass!}">${msg("loginOtpOneTime")}</label>
			<div>
		...
		<form onsubmit="login.disabled = true; return true;" id="kc-sms-code-login-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
			<div class="${properties.kcFormGroupClass!}">
				<div class="${properties.kcInputWrapperClass!}">
					<input type="number" id="code" name="code" class="${properties.kcInputClass!}" autocomplete="off" 
						autofocus/>
					</div>
			</div>
			<div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
				...
				<div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
					<div class="button-contain">
						<input id="login-OTP" name="login" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" type="submit" value="${msg("doSubmit")}"/>
						<div>
